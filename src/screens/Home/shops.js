          ...
          <View style={{ width: wp('100%'), marginTop: 15 }}>
            <Grid
              ...
              renderItem={({ item, index }) => {
                return (
                  this.state.view == 2 ? <ProductsItem1 item={item} onPress={() => this.props.navigation.navigate('Detail')} /> : <ProductsItem2 item={item} onPress={() => this.props.navigation.navigate('Detail')} />
                )
              }}
...
export default connect(undefined, undefined)(Shops);
