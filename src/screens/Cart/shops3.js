...
class Shops3 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
          ...
          <View style={{ width: wp('100%'), marginTop: 15 }}>
            <Grid
              ...
              renderItem={({ item, index }) => {
                return (
                    this.state.view == 2 ? <ProductsItem1 item={item} onPress={()=>this.props.navigation.navigate('Detail3')}  /> : <ProductsItem2 item={item} onPress={()=>this.props.navigation.navigate('Detail3')}  />
                )
              }}
...
export default connect(undefined, undefined)(Shops3);
