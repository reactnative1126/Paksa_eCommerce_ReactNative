    ...
    return (
      <Container style={styles.container}>
        ...
        <Content>
          ...
          <ImageOne image={images.banner20} style={{ height: 120 }} onPress={() => this.props.navigation.navigate('Shops1')} />
          ...
          <Products style={{ width: wp('100%'), padding: 15, backgroundColor: '#EDEDED' }}>
            ...
            <ProductsList data={dummy.recommends} style={{ marginTop: 15 }} onPress={() => this.props.navigation.navigate('Detail1')}/>
          </Products>
...
export default connect(undefined, undefined)(Detail1);
